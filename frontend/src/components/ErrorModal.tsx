      ...
      <View style={styles.overlay}>
        ...
        >
          <View style={styles.hero}>
            <View style={[styles.heroStripe, { backgroundColor: config.color }]} />
            <View style={styles.heroIconRow}>
              <View style={[styles.heroIconOuter, { borderColor: config.color + '55' }]}>
                <View style={[styles.heroIconInner, { backgroundColor: config.color + '18' }]}>
...
const styles = StyleSheet.create({
  ...
  actions: { padding: 20, paddingTop: 10, gap: 12 },
  button: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 14, borderRadius: 16, gap: 10 },
  buttonTextRetry: { color: '#FFF', fontSize: 16, fontWeight: '800' },
