...
const NCIMyRequestsScreen: React.FC<NCIMyRequestsScreenProps> = ({ user, onBack }) => {
  ...
  const onRefresh = () => {
    console.log('🔄 [REFRESH] NCI/MyRequests'); setRefreshing(true); fetchRequests(); };
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: '#F1F5F9' }]}>
      ...
      <SinglePassDetailsModal
        ...
        timelineSteps={selectedRequest ? (() => {
          ...
          const hodDone = s === 'APPROVED' || s === 'PENDING_HR';
          const hodRejected = s === 'REJECTED' && selectedRequest.hodApproval === 'REJECTED';
          const hrDone = s === 'APPROVED';
          const hrRejected = s === 'REJECTED' && selectedRequest.hrApproval === 'REJECTED';
          return [
...
const styles = StyleSheet.create({
  ...
  avatarWrap: { width: 42, height: 42, borderRadius: 21, backgroundColor: '#E0E7FF', alignItems: 'center', justifyContent: 'center' },
  avatarText: { fontSize: 14, fontWeight: '800', color: '#3730A3' },
  cardMeta: { flex: 1 },
